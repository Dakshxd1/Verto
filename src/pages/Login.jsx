...
const Login = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-center px-4 overflow-hidden relative">
      ...
      >
        <div className="bg-white/10 backdrop-blur-2xl rounded-3xl p-8 shadow-2xl border border-white/20 overflow-hidden">
          {/* Gradient Border Effect */}
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-blue-500/10 via-transparent to-indigo-500/10 pointer-events-none" />
